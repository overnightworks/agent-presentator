Audience: every agent that edits this repository.
...
documentation layers; `docs/VISION.md` owns why this tool exists and what the
operator wants from it; `docs/PRODUCT.md` owns implementation status;
