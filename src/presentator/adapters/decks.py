...
# the PDF that is already downloadable (line 16). Whether the row is marked
# removed is left out too: that mark is `mark_removed_except`'s alone, cleared
# there when the folder is carried again.
_PUT_DECK: Final = """
