"""Bootstrap Magpie after reserving stdout for its binary protocol."""
...
from presentator_speech_provider_contract import MagpieSpeaker
...
def main() -> int:
    ...
    from presentator_magpie.model import load_model, pcm_chunks
...
def _arguments() -> argparse.Namespace:
    ...
    parser.add_argument("--speaker", type=MagpieSpeaker, required=True)
